...
# payment router devre dışı — satın alma akışı yerine katılım kodu sistemi kullanılıyor
...
# app.include_router(payment.router)  # satın alma akışı devre dışı
...
# Static dosyaları serve et (örneğin yüklenen resimler için)
