  ...
  return (
    <div className="absolute inset-0 bg-white flex flex-col items-center relative overflow-hidden">
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto no-scrollbar shrink">
          ...
          <div className="hidden lg:flex h-16 md:h-16 px-3 bg-white border-2 border-gray-200 border-b-4 rounded-2xl items-center gap-4 shadow-sm ml-1">
            ...
            <div className="flex flex-col justify-center">
              ...
              <span
                className={`text-xs font-bold flex items-center gap-1 px-2 py-0.5 rounded-full w-fit ${currentCourse.instructor.isOnline ? "text-green-500 bg-green-50" : "text-gray-400 bg-gray-100"}`}
              >
                {currentCourse.instructor.isOnline && (
          ...
          >
            ...
            {isClanDropdownOpen && (
              <div
                className="absolute top-[110%] md:right-0 bg-white border-2 border-indigo-100 rounded-2xl shadow-xl z-[60] overflow-hidden w-64 animate-in fade-in slide-in-from-top-2 duration-200 cursor-default"
              ...
              >
                  ...
                  {squadMembers.map((member) => (
                    ...
                    >
                      <div className="relative">
                        ...
                        />
                        <div
                          className={`absolute -bottom-1 -right-1 w-2.5 h-2.5 rounded-full border-2 border-white ${member.status === "online" ? "bg-green-500" : member.status === "in-class" ? "bg-yellow-500" : "bg-gray-400"}`}
                        ></div>
                      </div>
                      <div>
                        <h4 className="font-bold text-sm text-gray-800 leading-none mb-0.5">
                          {member.name}
                        </h4>
                        <span className="text-[10px] text-gray-400 font-medium uppercase">
                          {member.status === "in-class"
                            ? "Derste"
                            : member.status}
                        </span>
                      </div>
                ...
                <div className="p-2 border-t border-indigo-50 bg-gray-50 text-center">
                  <button className="text-[10px] font-black text-indigo-500 hover:text-indigo-600 uppercase tracking-wide">
                    Tümünü Gör
                  </button>
                </div>
              </div>
            ...
            <div className="w-full bg-white border-2 border-gray-100 border-b-4 rounded-2xl p-2 flex items-center justify-between shadow-sm relative overflow-hidden group hover:border-yellow-200 transition-colors">
              ...
              <div className="flex items-center gap-3 relative z-10">
                ...
                <div
                  ...
                  style={{
                    backgroundColor:
                      currentCourse.themeColor === "#3b82f6"
                        ? "#60a5fa"
                        : "#facc15",
                    borderColor:
                      currentCourse.themeColor === "#3b82f6"
                        ? "#3b82f6"
                        : "#eab308",
                    boxShadow: `0 2px 0 ${currentCourse.themeColor === "#3b82f6" ? "#2563eb" : "#ca8a04"}`,
                  }}
                >
          ...
          <div className="absolute top-full mt-4 right-0 hidden xl:flex flex-col gap-4 w-64">
            ...
            <div className="bg-white rounded-2xl border-2 border-gray-200 border-b-4 p-3 shadow-sm hover:shadow-md transition-all group">
              <div className="flex justify-between items-center mb-2.5">
                ...
                <a
                  href="#"
                  className="font-bold text-xs text-green-500 hover:text-green-600 transition-colors uppercase tracking-wider bg-green-50 px-3 py-1 rounded-lg"
                >
                  TÜMÜ
                </a>
              </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between mb-1">
                      <span className="font-bold text-gray-700 text-sm font-display">
                        10 Puan kazan
                      </span>
                ...
                return (
                  <React.Fragment key={node.id}>
                    ...
                    >
                      ...
                      {/* Text Bubble */}
                      <div
                        className={`absolute bottom-full left-1/2 -translate-x-1/2 z-[60] origin-bottom transition-all duration-300 ease-out ${
                          activeNodeId === node.id && !node.isLocked
                        ...
                        <div className="relative min-w-[240px] transform hover:-translate-y-1 transition-transform duration-300 group/bubble cursor-default">
                          ...
                          <div
                            ...
                            style={{
                              ...
                              borderColor:
                                node.strokeColor || "rgba(0,0,0,0.1)",
                            }}
                          >
                            {/* Glow Shapes */}
                            ...
                            <div className="absolute top-4 right-6 text-white/30 text-2xl animate-pulse">
                              ✨
                            </div>
                          </div>
                          ...
                          {/* Tail */}
                          <div
                            className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-6 h-6 rotate-45 rounded-sm"
                            style={{ backgroundColor: node.baseColor }}
                          ></div>
                          ...
                          <div className="relative z-10 p-5 flex flex-col items-start text-left">
                            ...
                            >
                              <span
                                className="font-black text-sm md:text-base uppercase tracking-wider"
                                style={{ color: node.baseColor }}
                              >
                                BAŞLAT +10 PUAN
                              </span>
                            </button>
                      ...
                      {/* Hover Ring Effect */}
                      <div
                        className={`absolute top-[75%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-44 h-16 border-8 rounded-[100%] opacity-0 group-hover:opacity-100 group-hover:scale-105 transition-all duration-300 pointer-events-none z-0 ${node.ringColor} ${node.isLocked ? "hidden" : ""}`}
                      ></div>
                      ...
                      <div
                        className={`absolute inset-0 flex items-center justify-center z-20 ${node.iconOffset || ""}`}
                      >
                        {node.icon ? (
                          <>
                    ...
                    {index < currentNodes.length - 1 && (
                      <>
                        ...
                        {node.lessonNumber &&
                        currentNodes[index + 1]?.lessonNumber !==
                          node.lessonNumber &&
                        currentNodes[index + 1]?.lessonTopic ? (
                          ...
                          <div className="w-32 h-24 -mx-6 relative z-0 flex items-center justify-center">
                            ...
                            <img
                              src={GrassIcon}
                              alt=""
                              className={`absolute w-5 opacity-80 ${index % 2 === 0 ? "-rotate-6" : "rotate-3"}`}
                              style={{
                                left: "10%",
                                top: node.curve === "down" ? "45%" : "55%",
                                transform: `translate(0, ${index % 2 === 0 ? "5px" : "-5px"})`,
                              }}
                            />
                            <img
                              src={GrassIcon}
                              alt=""
                              className={`absolute w-6 opacity-90 ${index % 3 === 0 ? "rotate-6" : "-rotate-3"}`}
                              style={{
                                left: "30%",
                                top: node.curve === "down" ? "65%" : "35%",
                                transform: `translate(0, ${index % 3 === 0 ? "-8px" : "4px"})`,
                              }}
                            />
                            <img
                              src={GrassIcon}
                              alt=""
                              className={`absolute w-7 opacity-85 ${index % 2 !== 0 ? "rotate-3 scale-110" : "-rotate-3 scale-90"}`}
                              style={{
                                left: "50%",
                                top: node.curve === "down" ? "80%" : "25%",
                                transform: `translate(0, ${index % 4 === 0 ? "10px" : "-2px"})`,
                              }}
                            />
                            <img
                              src={GrassIcon}
                              alt=""
                              className={`absolute w-5 opacity-80 ${index % 2 === 0 ? "rotate-12" : "-rotate-6"}`}
                              style={{
                                left: "70%",
                                top: node.curve === "down" ? "85%" : "25%",
                                transform: `translate(0, ${index % 2 !== 0 ? "6px" : "-6px"})`,
                              }}
                            />
                            <img
                              src={GrassIcon}
                              alt=""
                              className={`absolute w-6 opacity-75 ${index % 3 === 0 ? "-rotate-3" : "rotate-6"}`}
                              style={{
                                left: "90%",
                                top: node.curve === "down" ? "70%" : "35%",
                                transform: `translate(0, ${index % 3 !== 0 ? "-5px" : "5px"})`,
                              }}
                            />
                          </div>
                        )}
      ...
      <LessonSlide
        ...
        lessonTitle={
          currentCourse.nodes.find((n) => n.id === lessonLevel)?.title
        }
