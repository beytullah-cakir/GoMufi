...
interface AddCourseModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSave: (courseData: { title: string; category: string; color: string }) => void;
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm transition-opacity animate-fade-in">
            <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl overflow-hidden relative">
                <div className="px-6 pt-6 flex justify-between items-center">
                    <h3 className="text-xl font-black text-gray-800">{initialData ? 'Kursu Düzenle' : 'Yeni Kurs Ekle'}</h3>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="pt-2 flex gap-3">
                        ...
                        <button
                            ...
                            className={`flex-1 py-3 font-bold rounded-xl shadow-lg transition-all ${!title || !selectedCategory
