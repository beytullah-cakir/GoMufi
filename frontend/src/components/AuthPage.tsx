                  ...
                  {!isLogin && (
                    <div className="group">
                      <input
                        ...
                        className={`w-full px-6 py-4 bg-gray-50/50 border border-gray-200 rounded-2xl text-gray-800 font-bold focus:outline-none focus:bg-white focus:ring-4 transition-all duration-300 placeholder-gray-400 text-base focus:border-opacity-0 ${
                          role === "student"
