              ...
              <div className="animate-fade-in">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    className="group/google w-full py-4 px-6 rounded-2xl border-2 border-gray-100 bg-white text-gray-700 font-bold text-lg shadow-sm hover:shadow-lg hover:border-gray-200 hover:scale-[1.02] active:scale-95 transition-all duration-300 flex items-center justify-between"
                  >
                    ...
                    <ChevronRight className="text-gray-200 group-hover/google:text-gray-400 group-hover/google:translate-x-1.5 transition-all w-6 h-6" />
                  </button>
                </form>
