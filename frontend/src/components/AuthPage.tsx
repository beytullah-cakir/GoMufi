    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 flex flex-col items-center justify-center p-4 relative overflow-hidden font-display selection:bg-indigo-200">
            ...
            <div className="relative z-10 w-full max-w-6xl flex flex-col md:flex-row items-center justify-center gap-10 md:gap-32">
                ...
                {/* Mascot Section (Left or Top) - The Host */}
                <div className={`flex flex-col items-center transition-all duration-700 ease-out z-20 ${role ? 'scale-90 md:scale-100' : 'scale-100'}`}>
                ...
                <div className="w-full max-w-md perspective-1000">
                    <div className="bg-white/70 backdrop-blur-xl rounded-[3rem] p-8 md:p-12 shadow-2xl relative border border-white/60 box-border transition-all duration-500 hover:shadow-purple-200/50 hover:bg-white/80">
                        ...
                        <div className="flex justify-center mb-10">
                            <img src={LogoText} alt="GoMufi" className="h-32 object-contain opacity-90 drop-shadow-sm" />
                        </div>

                        {!role ? (
                            /* Role Selection View - Modern Cards */
                            <div className="animate-fade-in space-y-6">
                                <div className="text-center">
                                    <h2 className="text-4xl font-black text-gray-800 mb-3 tracking-tighter">Karakterini Seç</h2>
                                ...
                                <div className="mb-8 relative pl-2">
                                    ...
                                    <div className="text-center pt-2">
                                        ...
                                        <h2 className="text-3xl font-black text-gray-800 mb-1 tracking-tight">
                                            {isLogin ? (role === 'student' ? 'Tekrar Hoşgeldin!' : 'Hoşgeldiniz') : 'Hesap Oluştur'}
                                        </h2>
                                    </div>
                                </div>
