      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="w-full bg-white border-2 border-gray-200 border-b-4 rounded-3xl p-8 mb-8 flex flex-col md:flex-row items-center gap-8 shadow-sm">
          ...
          <div className="flex-1 text-center md:text-left">
            <h2 className="text-4xl font-black text-gray-800 font-display mb-1">
              {username}
            </h2>
            <p className="text-gray-400 font-bold text-lg mb-2 tracking-wide">
              {email} • Aralık 2025'te katıldı
            </p>
            {userData?.student_code && (
              <div className="mb-6 inline-flex items-center gap-2 px-3 py-1 bg-indigo-50 text-indigo-600 rounded-lg text-sm font-black border border-indigo-100 uppercase tracking-wider">
        ...
        {/* STATS GRID */}
        <h3 className="text-2xl font-black text-gray-800 font-display mb-6">
          İstatistikler
        </h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          ...
          <div className="bg-white border-2 border-gray-200 border-b-4 rounded-2xl p-4 flex flex-col gap-2 shadow-sm hover:-translate-y-1 transition-transform cursor-default">
            ...
            <span className="text-3xl font-black text-yellow-500 font-display">
              Bronz
            </span>
          </div>
        ...
        <div className="flex justify-between items-end mb-6">
          ...
          <a
            href="#"
            className="font-bold text-indigo-500 hover:text-indigo-600 uppercase text-xs tracking-wider border-b-2 border-transparent hover:border-indigo-200"
          >
            Tümünü Gör
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex items-center gap-4 bg-yellow-50 border-2 border-yellow-200 border-b-4 rounded-2xl p-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-500 text-sm font-bold leading-tight mb-3">
                Tek bir derste hiç hata yapma.
              </p>
