      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
          ...
          <div className="space-y-4">
            ...
            {[
              {
                title: "Python: Temel Algoritmalar",
                students: 450,
                rating: 4.8,
                status: "Yayında",
                progress: 75,
              ...
              <div
                key={i}
                className="grid grid-cols-12 items-center p-4 rounded-2xl hover:bg-gray-50 transition-colors group"
              >
                <div className="col-span-5 flex items-center gap-4">
                  <div
                    className={`w-10 h-10 rounded-xl bg-${course.color}-100 flex items-center justify-center text-xl`}
                  >
                    {i === 0 ? "🐍" : i === 1 ? "🌐" : i === 2 ? "🎮" : "📊"}
                  </div>
                  <div>
                    <h4 className="font-bold text-gray-800 text-sm group-hover:text-sky-600 transition-colors">
                      {course.title}
                    </h4>
                ...
                <div className="col-span-3 text-right">
                  <span
                    className={`text-xs font-bold px-3 py-1 rounded-full ${course.status === "Yayında" ? "bg-green-100 text-green-600" : "bg-gray-100 text-gray-500"}`}
                  >
                    {course.status}
                  </span>
                </div>
